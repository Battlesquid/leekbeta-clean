...
exports.default = (function (bot, message) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, commandName, args, command, meetsRequirements;
    var _b, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 1:
                ...
                if (!command)
                    return [2 /*return*/];
                return [4 /*yield*/, command.meetsRequirements(message)];
            case 2:
                meetsRequirements = _d.sent();
